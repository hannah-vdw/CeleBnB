feature 'can book property' do
  ...
  scenario 'user can book a property for one night' do
    ...
    expect(page).to have_content("Congratulations #{user_result.first['username']}, your booking at #{property_result.first['name']} for #{booking_result.first['booking_date']} is confirmed!")
  end
end
